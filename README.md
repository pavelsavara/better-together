...
5. You never know how many rounds remain in the match — so there's no "last round" to safely defect on.
6. The tournament crown isn't "highest score" — it's **"Best Co-Player"**: whose presence makes every group they join thrive?
...
├── samples/        Reference bots (Ferris, Corro, Khaos)
